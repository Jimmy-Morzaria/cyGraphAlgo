...
import org.cytoscape.graph.algorithms.impl.PrimMSTImpl;
import org.cytoscape.graph.algorithms.impl.PrimMSTStatsImpl;
...
public class PrimMSTImplTest {
	...
	public void testFindTree() {
		...
		PrimMSTStatsImpl primStats = prim.findTree(network, new WeightFunction() {
