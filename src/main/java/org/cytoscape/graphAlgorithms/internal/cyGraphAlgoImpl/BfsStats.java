...
public class BfsStats {
	...
	public BfsStats(CyNode source, CyNetwork network, boolean marked[], int distTo[], int edgeTo[], Map<CyNode, Integer> nodeToIndexMap, Map<Integer, CyNode> indexToNodeMap){
