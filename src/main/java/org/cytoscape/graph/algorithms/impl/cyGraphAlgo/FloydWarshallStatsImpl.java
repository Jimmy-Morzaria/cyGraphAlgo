 ...
 *
 */
public class FloydWarshallStatsImpl implements FloydWarshallStats{
	...
	public FloydWarshallStatsImpl(Map<CyNode, Integer> nodeToIndexMap, double distTo[][], CyEdge edgeTo[][], boolean negativeCycle){
