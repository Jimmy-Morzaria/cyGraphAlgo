...
public class HITSImpl implements HITS {
	...
	public HITSResults compute(CyNetwork network, boolean directed) {
		...
		while (true) {
			...
			updateAuthorityValue(network, tempAuthority, tempHubs, directed);
			updateHubValue(network, tempHubs, tempAuthority, directed);
	...
	private void updateHubValue(CyNetwork network, double tempHubs[], double tempAuthority[],
			boolean directed) {
	...
	private void updateAuthorityValue(CyNetwork network,
			double tempAuthority[], double tempHubs[], boolean directed) {
